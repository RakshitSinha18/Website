// FAQ copy — shared by the homepage FAQ section and the FAQPage JSON-LD
// (structured-data.tsx), so the rich-result markup can never drift from what
// visitors actually read. Edit here to change both.
